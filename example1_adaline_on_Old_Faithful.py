...
def main():
    ...
    stratified_training_set_predictors  = standardize(stratified_training_set[:,1:3])
    ...
    stratified_test_set_predictors      = standardize(stratified_test_set[:,1:3])
    #print("standardized stratified_test_set_predictors = ", stratified_test_set_predictors)
